...
<div class="max-w-3xl mx-auto p-6">
    ...
    <!-- Page Title -->
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-700 mb-1">Edit Role</h2>
        <p class="text-gray-500 text-sm">Modify the role name and manage assigned permissions below.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
        <form action="{{ route('role.update', $role->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="role_name" value="{{ old('name', $role->name) }}"
...
@php
$pageActionText = '<i class="fa-solid fa-arrow-left-long"></i> Roles List';
$pageActionLink = route('role.list');
@endphp